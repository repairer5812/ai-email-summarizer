...
- 가장 쉬운 방법:
  ...
  - 예: `https://github.com/repairer5812/ai-email-summarizer/archive/refs/tags/v0.6.5.2.zip`
  - 예: `https://github.com/repairer5812/ai-email-summarizer/archive/refs/tags/v0.6.5.2.tar.gz`
- 또는 git 사용 가능하면:
...
4) AI 설정(로컬 또는 클라우드)
   - 로컬 기본값은 `빠름 — EXAONE 4.0 1.2B`이며, 필요 시 `표준(Gemma 4 E4B)/성능(Qwen 3.5 4B)`으로 변경할 수 있습니다.
