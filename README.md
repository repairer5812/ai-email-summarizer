...
- 가장 쉬운 방법:
  ...
  - 예: `https://github.com/repairer5812/ai-email-summarizer/archive/refs/tags/v0.6.5.6.zip`
  - 예: `https://github.com/repairer5812/ai-email-summarizer/archive/refs/tags/v0.6.5.6.tar.gz`
- 또는 git 사용 가능하면:
