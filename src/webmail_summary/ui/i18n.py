...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "setup.sender_filter.placeholder": "e.g. from:a@company.com, domain:company.com, subject:invoice",
        "setup.sender_filter.help": "Empty = sync all mail. Rules are comma-separated. Use from:, domain:, and subject:. Plain values keep backward-compatible sender matching.",
    ...
    "ko": {
        ...
        "setup.sender_filter.placeholder": "예: from:a@company.com, domain:company.com, subject:견적",
        "setup.sender_filter.help": "비우면 전체 메일을 동기화합니다. 규칙은 쉼표(,)로 구분하며 from:, domain:, subject: 를 지원합니다. 접두어 없는 값은 기존처럼 발신자 기준으로 처리됩니다.",
