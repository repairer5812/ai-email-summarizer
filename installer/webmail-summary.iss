...
[Files]
; PyInstaller --onedir output: webmail-summary.exe plus its _internal\ folder.
Source: "..\dist\webmail-summary\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
